...
- =media.peerconnection.enabled= to false (now to true)
...
- install OpenBoard from F-Droid Basic and disable GBoard
...
- Olauncher Clutter Free, ReTerminal
- Syncthing-Fork, Orgro, Librera FD
- Tuta, Tuta Calendar, Silence
- SimpMusic, Orgzily Revived
- Aurora Store, Aegis
- NewPipe, Feeder
...
- Kena Mobile, Trade Republic
- Firefox, Beats, WhatsApp
- IO, Arriva MyPay, 3BMeteo
- Maps, Translate
- Companion
