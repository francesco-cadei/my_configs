...
- Hide Topbar, No Titlebar When Maximized
...
- BasicSync, SpamBlocker, Fennec, NewPipe
- Tuta Calendar, Tuta, OpenCalc, BetterCounter
- Aegis Authenticator, Audio Recorder
- Feeder, ShowCase, Aiyo, Loop Habit Tracker
- Aurora Store


** Aurora Store, installs:
- Play Store, Bitwarden, Kena Mobile
- Aruba PEC, Trade Republic
- WhatsApp, 3BMeteo, IO, CieID
- Maps, Translate, Arriva MyPay, ATB Mobile
- Decathlon, Famila Nord, PosteID, coffee cApp
...
** tablet, installs:
- Olaucher, HeliBoard, BasicSync, Aegis Authenticator
- F-Droid Basic, Aurora Store, Saber
- Fennec (and extensions), Aiyo, LibreTorrent
- Librera FD, mpv, NewPipe, MuPDF mini
- Bitwarden, Tuta Calendar, Tuta
- Udemy
